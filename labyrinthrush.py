...
def room_menu():   
    ...
    pygame.display.set_caption("Joshua's Animation")
    ...
    while not done:
        ...
        menu = pygame.image.load("menu0.png")
...
# Define some colors
    ...
    while not done:
        ...
        menu = pygame.image.load("Controls.png")
        screen.blit(menu, (0,0))
        pygame.display.flip()
...
def room_game():
    ...
    player2 = Player(229, 73, False, "P2", 1)
    player3 = Player(206, 535, False, "P3", 2)
    player4 = Player(1028, 529, False, "P4", 3)
    ...
    wings = PowerUp(322, 369, "speed", "speed.png")
    ...
    while not done:
        ...
        if (minute <= 0 and sec < 0.02) or player1.score < 0 or player2.score < 0 or player3.score < 0 or player4.score < 0:
            ...
            for score in scores:
                place += 1
                print str(place) + ". " + score[1] + " with " + str(score[0])
...
# Define some colors
    ...
    while not done:
        ...
        menu = pygame.image.load("Scores.png")
        screen.blit(menu, (0,0))
        pygame.display.flip()
